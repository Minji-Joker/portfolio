...
$('.top-box .top-bar-2 .menu-box-1').mouseenter(function () {
    $('.top-box').addClass('hover');
});

$('.top-box .top-bar-2 .menu-box-1').mouseleave(function () {
    $('.top-box').removeClass('hover');
});
...
$(window).scroll(function () {
    ...
    if (scrollTop > 100) {
        $('html').attr('data-scroll-top-over-100', 'Y');
    } else {
        $('html').attr('data-scroll-top-over-100', 'N');
    }
});

$('.btn-toggle-modal-1').click(function () {
    if ($('.modal-1').hasClass('active')) {
        $('.modal-1').removeClass('active');
        $('.top-box').removeClass('hover2');
    } else {
        $('.modal-1').addClass('active')
        $('.top-box').addClass('hover2');
    }
});
/* 메인 슬라이더 */
/* 기능 */
...
/* 푸터 사이트맵 */
$('.footer > .footer-menu-1 > .btn-area .right > .btn').click(function () {
    var has = $('.footer > .site-menu-area').hasClass('active');
    if (has) {
        $('.footer > .site-menu-area').removeClass('active');
    } else {
        $('.footer > .site-menu-area').addClass('active');
    }
});
